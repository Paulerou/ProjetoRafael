...
public class AluguelDAO {
    ...
    static void alugarMoto() {
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            double valor = 100.0; // Exemplo de valor
    ...
    static Cliente selectClient(List<Cliente> clientes) {
    ...
    static void visualizarAlugueis() {
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
